// Premium Access and Model Capabilities - Extracted from original working script.js
...
function checkModelCapabilities(capabilityType) {
    ...
    const modelInfo = window.allModels ? window.allModels.find(m => m.id === modelId) : null;
    if (!modelInfo) {
