...
The implementation uses our improved Redis connection handling for better resilience.
"""
...
def init_app(app):
    ...
    try:
        ...
        # Import job-related functions here to avoid circular imports
        from jobs import (
        ...
        # but still have access to the job functions
