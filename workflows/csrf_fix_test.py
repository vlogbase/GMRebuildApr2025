"""
Test workflow to verify CSRF fixes are working properly.

This workflow runs the Flask application and allows us to test if our
CSRF token fixes have resolved the 400 Bad Request errors for AJAX endpoints.
"""
import os
import sys
import logging
